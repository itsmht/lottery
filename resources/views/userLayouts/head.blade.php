...
<head>
	...
	<style>
		.appBox.competition {background: url(../assets2/images/competitions/june-2019-giveaway-bg.jpg) transparent top no-repeat; background-size: cover;}
		.appBox.competition img {max-width: 80%;}
		@media (max-width: 768px) {
			.appBox.competition img {width: 300px; max-width: 80%; padding-bottom: 20px;}
		}
	</style>
	<style>	
...
<style>
	...
	#checker .remove{position: absolute; display:inline-block;width:30px;height:30px;background:url(../assets2/images/icons/icon-trash.svg) no-repeat center/ 100% 100%;cursor:pointer; top: 40px; left: -50px;}
