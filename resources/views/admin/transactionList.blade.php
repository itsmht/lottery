                          ...
                          <table class="table table-striped">
                             <thead>
                               <tr>
                                 ...
                                 <th scope="col">Binance/Nagad/Bkash</th>
                             ...
                             <tbody>
                               @foreach ($transactions as $company)


                               <tr>
                                 <th id="companyId" scope="row">{{$company->transaction_id}}</th>
                                 <td>{{$company->uniqueTID}}</td>
                                 <td>{{$company->binance_id}}</td>
                                 <td>{{$company->user->name}}</td>
                                 <td>{{$company->transaction_amount}}</td>
                                 <td>{{$company->transaction_type}}</td>
                                 @if($company->transaction_status=="Success")
                                   <td><span class="badge badge-success shadow-success m-1">Success</span></td>
                                   {{-- <button type="button" class="btn btn-success btn-round waves-effect waves-light m-1">Active</button>  --}}
                                   @else
                                   {{-- <button type="button" class="btn btn-danger btn-round waves-effect waves-light m-1">Pending</button>  --}}
                                   <td><span class="badge badge-danger shadow-danger m-1">Cancelled</span></td>
                                   @endif
