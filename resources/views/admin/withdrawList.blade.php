                          ...
                          <table class="table table-striped">
                             ...
                             <tbody>
                               ...
                               <tr>
                                 ...
                                 <td>
                                    <form action="{{route('approveWithdraw',['id'=>$company->transaction_id])}}" method="post">
                                      {{@csrf_field()}}
...
<script type="text/javascript">
     ...
     $('.show_confirm').click(function(event) {
          ...
          swal({
              ...
              text: "This action will affect the user's transaction status'.",
              icon: "warning",
              buttons: true,
              dangerMode: true,
          })
