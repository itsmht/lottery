        ...
        <div class="card-body">
            <div class="card-content p-2">
                <div class="text-center">
                    <img style="width: 273px; height:100px;" src="assets/images/logo1.jpg" class="logo-icon" alt="logo icon">
                </div>
                ...
                <form action="{{route('forgotPasswordSubmit')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative has-icon-right">
                            <input type="text" id="exampleInputUsername" name="email" value="{{ old('email') }}" class="form-control input-shadow" placeholder="Enter Email">
                            @error('email')
